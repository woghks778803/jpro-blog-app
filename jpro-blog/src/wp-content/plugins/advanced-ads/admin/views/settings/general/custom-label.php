...
<p class="description"><?php esc_html_e( 'Displayed above ads.', 'advanced-ads' ); ?>&nbsp;
	<a target="_blank" href="<?php echo esc_url( ADVADS_URL . 'manual/advertisement-label/?utm_source=advanced-ads&utm_medium=link&utm_campaign=settings-advertisement-label' ); ?>" class="advads-manual-link">
										<?php
